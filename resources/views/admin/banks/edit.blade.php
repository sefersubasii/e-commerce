        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Banka Düzenle</h4>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-15">Banka Düzenle</h3>

                        <form method="post" action="{{url('admin/settings/bank/update/'.$data->id)}}" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade active in" id="tab1">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="file" name="image" data-default-file="{{asset('src/uploads/banks/'.$data->image)}}" id="input-file-now" class="dropify">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="owner" id="owner" value="{{$data->owner}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="iban" class="col-sm-2 control-label">IBAN</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="iban" id="iban" value="{{$data->iban}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
