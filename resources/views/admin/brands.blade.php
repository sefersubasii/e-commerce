        ...
        <div class="container-fluid">
            <div class="row bg-title">
                ...
                <div class="col-lg-2 col-sm-4 col-md-3 col-xs-4 pull-right">
                    <a href="{{url('admin/brands/add')}}" class="btn btn-block btn-success btn-rounded"><i class="fa fa-plus"></i> Marka Ekle</a>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                        ...
                        <div class="table-responsive">
                            <table id="brands" class="display table dataTable no-footer" style="width: 100%;" role="grid" aria-describedby="brands_info">
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 176px;">Ürün Sayısı</th>
...
@section('scripts')
    ...
    serverSide: true,
    ordering:false,
    ajax: "{{url('admin/brands/datatable')}}",
    columns: [
