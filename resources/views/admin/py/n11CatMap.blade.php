                    ...
                    <div class="xcontent">
                        <div class="table-responsive">
                            <table id="banks" class="display table dataTable no-footer" style="width: 100%;" role="grid" aria-describedby="brands_info">
                                <thead>
                                <tr role="row">
                                    <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 30%;">Kategori ID</th>
                                    <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 30%;">Kategori</th>
                                    <th class="sorting_disabled" rowspan="1" colspan="1">N11 Şablonu</th>
                                    <th class="sorting_disabled" rowspan="1" colspan="1">N11 Kategorisi</th>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form method="POST" action="{{url('admin/n11/category/map/create')}}" id="createN11temp" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                                ...
                                                <div class="form-group">
                                                    <label for="templateName" class="col-sm-2 control-label">N11 Satış Şablonu</label>
                                                    <div class="col-sm-10">
                                                        <select name="n11template_id" id="" title="Seçiniz" data-style="form-control" class="selectpicker show-tick bs-select-hidden">
                                                ...
                                                <div class="n11Cats">
                                                    <div class="form-group">
                                                        <label for="n11catName" class="col-sm-2 control-label">N11 Kategorisi</label>
                                                        <div class="col-sm-10">
                                                            <select onchange="showN11Categories(this.value,0)" name="" id="n11catName" title="Seçiniz" data-style="form-control" rel="n11-category" class="selectpicker show-tick bs-select-hidden">
                                                                @foreach($n11Cat as $k => $v)
                                                                    <option value="{{$v->id}}">{{$v->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div id="n11-sub-category-0"></div>
                                                    <input name="n11CategoryId" id="n11CategoryId" value="" type="hidden"> 
                                                    <input name="n11CategoryPath" id="n11CategoryPath" value="" type="hidden">
                                                    <input name="localCategoryPath" id="localCategoryPath" value="" type="hidden">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            var oTable = $('#banks').DataTable({
                ...
                serverSide: true,
                ordering:false,
                ajax: "{{url('admin/n11/category/map/datatable')}}",
                columns: [
                    {data: 'category_id', name: 'category_id', orderable: false, searchable: true},
                    {data: 'category', name: 'category', orderable: false, searchable: false},
                    {data: 'n11_template.name', name: 'n11_template.name', orderable: false, searchable: false},
                    {data: 'n11category', name: 'n11category', orderable: false, searchable: false},
                    { "mRender": function ( data, type, row ) {
                        return '<a href="{{url('./')}}/admin/n11/category/map/delete/'+row.id+'" data-toggle="tooltip" title="Sil" onclick="return confirm(\'Silmek İstediğinize Eminmisiniz?\')" class="btn btn-xs btn-danger btn-rounded"><i class="glyphicon glyphicon-remove"></i></a>';                    
