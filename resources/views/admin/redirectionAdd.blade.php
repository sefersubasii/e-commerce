    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-15">Yönlendirme Ekle</h3>

                        <h1>{{session('status')}}</h1>

                        <form method="post" action="{{url('admin/redirection/create/')}}" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            <div class="form-body">
                                <div class="form-group">
                                    <label for="oldUrl" class="col-sm-2 control-label">Eski Url</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="oldUrl" id="oldUrl" value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="newUrl" class="col-sm-2 control-label">Yeni Url</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="newUrl" id="newUrl" value="">
                                    </div>
                                </div>
                            </div>
