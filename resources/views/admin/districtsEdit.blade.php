        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">İlçe Düzenle</h4>
                </div>
                <div class="col-lg-2 col-sm-4 col-md-3 col-xs-4 pull-right">
                    <a href="{{url('admin/districts?city_id='.$data->cities_id)}}" class="btn btn-block btn-default btn-rounded">← Şehirler</a>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-15">İlçe Düzenle</h3>

                        <form method="post" action="{{url('admin/districts/update/'.$data->id.'?city_id='.$data->cities_id)}}" class="form-horizontal form-bordered">
                            <div class="form-body">
