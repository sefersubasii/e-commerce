        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Yeni Şehir Ekle</h4>
                </div>
                <div class="col-lg-2 col-sm-4 col-md-3 col-xs-4 pull-right">
                    <a href="{{url('admin/cities')}}" class="btn btn-block btn-default btn-rounded">← Şehirler</a>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-15">Şehir Ekle</h3>

                        <form method="post" action="{{url('admin/cities/update/'.$data->id.'?country_id='.$data->country_id)}}" class="form-horizontal form-bordered">
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    <label for="name" class="col-sm-2 control-label">Şehir Adı</label>
                                    <div class="col-sm-10">
