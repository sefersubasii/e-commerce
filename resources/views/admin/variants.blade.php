        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Tüm Varyantlar</h4>
                </div>

                <div class="col-lg-2 col-sm-4 col-md-3 col-xs-4 pull-right">
                    <a href="{{url('admin/variants/add')}}" class="btn btn-block btn-success btn-rounded"><i class="fa fa-plus"></i> Varyant Ekle</a>
                </div>
                <!-- /.col-lg-12 -->
            </div>
    ...
    <script>
        $(function() {
            $('#brands').DataTable({
                ...
                serverSide: true,
                ordering:false,
                ajax: "{{url('admin/variants/datatable')}}",
                columns: [
