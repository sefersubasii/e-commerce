        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Varyant Düzenle</h4>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-15">Varyant Düzenle</h3>

                        <form method="post" action="{{url('admin/variants/update/'.$variant->id)}}" class="form-horizontal form-bordered">
                            <div class="form-body">
                                <div class="form-group">
                                    <label for="name" class="col-sm-2 control-label">Varyant Adı</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="{{$variant->name}}" name="name" id="name">
                                    </div>
                                </div>
                                ...
                                */ ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="checkbox" {{$variant->filter_status == 1 ? "checked" : ""}} name="add_filter" value="1" id="add_filter" class="js-switch" data-size="medium" data-color="#4F5467" data-switchery="true" style="display: none;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div id="degerler">
                                            @foreach($variant->vals as $val)
                                                <div id="{{$val->id}}" style="margin-bottom:10px;">
                                                    <label class="col-sm-1 control-label">Değer Adı</label>
                                                    <div class="col-sm-8">
                                                        <input type="text" value="{{$val->value}}" class="form-control" name="degerler[]">
                                                    </div>
                                                    <div class="col-md-2"><button type='button' class='btn btn-danger' onclick="$.deleteDivFromId({{$val->id}})"><i class='fa fa-close'></i> Sil</button></div>
