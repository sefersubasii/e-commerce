    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-15">Özellik Grubu Ekle</h3>

                        <h1>{{session('status')}}</h1>

                        <form method="post" action="{{url('admin/attributeGroups/create')}}" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            <div class="form-body">
