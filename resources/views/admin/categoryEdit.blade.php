    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-15">Kategori Düzenle</h3>

                        <form method="post" action="{{url('admin/categories/update/'.$data->id)}}" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade active in" id="tab1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <select name="parent_id" class="selectpicker bs-select-hidden" data-style="form-control" data-live-search="1" title="Seçiniz" data-width="100%">
                                                @if($data->parent_id!=0)
                                                    <option value="0">ANA KATEGORİ YAP</option>
                                                @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="file" name="image" data-default-file="{{asset('src/uploads/category/'.$data->image)}}" id="input-file-now" class="dropify">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input-file-now" class="col-sm-2 control-label">Kapak Resmi</label>
                                        <div class="col-sm-10">
                                            <input type="file" name="imageCover" data-default-file="{{asset('src/uploads/category/cover/'.$data->imageCover)}}" id="input-file-now" class="dropify">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="tab2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="checkbox" {{$data->slug!=str_slug($data->title) ? "checked" : ""}} name="custom_url" value="1" class="js-switch" data-size="medium" data-color="#4F5467" data-switchery="true" style="display: none;">
                                        </div>
                                    </div>
                                    <div class="form-group">
    ...
    <script>
        $( document ).ready(function() {
            ...
            drp.on('dropify.afterClear', function(event, element){
                ...
                var inpName = $(element)[0].input.attr('name');
                var url = "{{url('/')}}"+"/admin/categories/"+inpName+"Delete";
                console.log(url);
                $.ajax({
                    url: url,
                    type: "POST",
