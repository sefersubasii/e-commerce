                        ...
                        <div class="table-responsive">
                            <table id="brands" class="display table dataTable no-footer" style="width: 100%;" role="grid" aria-describedby="brands_info">
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting_disabled" rowspan="1" colspan="1">Mail Grubu</th>
    ...
    <script>
        $(function() {
            $("body").on("click",".shortEditBtn",function(e){
                ...
                $.ajax({
                    url: "{{url('admin/mail/mailListShortEdit')}}",
                    type:'POST',
                    contentType: false,
                    data: formData,
                    processData: false,
            ...
            $('#brands').DataTable({
                ...
                serverSide: true,
                ordering:false,
                ajax: "{{url('admin/mail/mailList/datatable')}}",
                columns: [
                    {data: 'name', name: 'name', orderable: false, searchable: true},
                    {data: 'email', name: 'email', orderable: false, searchable: true},
                    {data: 'group.name', name: 'group.name', orderable: false, searchable: true},
