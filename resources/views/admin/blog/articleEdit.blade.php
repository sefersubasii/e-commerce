        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Yeni Makale Ekle</h4>
                </div>
                <div class="col-lg-2 col-sm-4 col-md-3 col-xs-4 pull-right">
                    <a href="{{url('admin/articles')}}" class="btn btn-block btn-default btn-rounded">← Makaleler</a>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-15">Makale Ekle</h3>

                        <form method="post" action="{{url('admin/article/update/'.$article->id)}}" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade active in" id="tab1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <select name="category_id" class="selectpicker bs-select-hidden" data-style="form-control" data-live-search="1" title="Seçiniz" data-width="100%">
                                    ...
                                    <div class="form-group">
                                        <label for="title" class="col-sm-2 control-label">Makale Adı</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="sort" id="sort" value="{{$article->sort}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input-file-now" class="col-sm-2 control-label">Resim</label>
                                        <div class="col-sm-10">
                                            <input type="file" data-default-file="{{asset('src/uploads/articles/'.$article->image)}}" name="image" id="input-file-now" class="dropify">
                                        </div>
                                    </div>
                                </div>
                                <div role="tabpanel" class="tab-pane fade" id="tab2">
                                    <div class="form-group">
                                        <label for="slug" class="col-sm-2 control-label">Makale Adresi</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="seo_title" id="seo_title" value="{{@json_decode($article->seo)->seo_title}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="seo_description" class="col-sm-2 control-label">Meta Açıklama</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="seo_description" id="seo_description" style="height: 140px;">{{@json_decode($article->seo)->seo_description}}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input value="{{@json_decode($article->seo)->seo_keywords}}" name="seo_keywords" id="seo_keywords" data-role="tagsinput" style="display: none;">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="tab3">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <textarea class="form-control editor"  name="content" style="height: 140px; visibility: hidden; display: none;">{{$article->content}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
