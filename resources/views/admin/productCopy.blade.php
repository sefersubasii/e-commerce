                    ...
                    <div class="white-box">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 text-right">
                                <button type="button" onclick="$.formSubmit('product_form');" class="btn btn-success"> <i class="fa fa-check"></i>Kaydet</button>
                            </div>
                        </div>

                        <form method="post" id="product_form" action="{{url('admin/products/createCopy')}}" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            <ul class="nav customtab nav-tabs" role="tablist">
                                ...
                                <li role="presentation" class="tab-disable"><a aria-controls="tab7" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-email"></i></span> <span class="hidden-xs">Resimler</span></a></li>
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade active in" id="tab1">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="name" id="name" value="{{$data->name}} Copy">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="stock_code" class="col-sm-2 control-label">Stok Kodu</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="stock_code" id="stock_code" value="{{$data->stock_code}}-copy">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="tab4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <select name="discount_type" id="discount_type" class="selectpicker show-tick bs-select-hidden" data-style="form-control" data-width="100%">
                                                ...
                                                <option value="3" {{$data->discount_type == "3" ? 'selected="selected"' : ''}} >İndirim Oranı</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="checkbox" checked="" name="use_system" value="1" class="js-switch" data-size="medium" data-color="#4F5467" data-switchery="true" style="display: none;">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="shipping_price" class="col-sm-2 control-label">Kargo Fiyatı</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="shipping_price" id="shipping_price" value="">
                                        </div>
                                    </div>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="tab5">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-10">
                                            <?php
                                            $cats="";
                                            foreach($data->categori as $c => $v){
                                                $cats .= $v->id.",";
                                            } ?>
                                            <input type="hidden" id="categories" name="categories" value="{{rtrim($cats,",")}}">
                                            <div id="tree">
                                            </div>
                                        ...
                                        @if(!empty($data->image))
                                            @foreach($data->image as $key => $value)
                                                ...
                                                <li class="sortableLi ui-state-default" id="pimage_{{$key}}">
                                                    ...
                                                    <a>
                                                        <img id="" src="{{url(url("/")."/src/uploads/products/".$value)}}">
                                                    </a>
                                                    <div class="sira">
