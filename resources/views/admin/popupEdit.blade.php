        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Popup Düzenle</h4>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <form method="post" action="{{url('admin/settings/popup/update/')."/".$popup->id}}" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            <div class="form-body">
                                <div class="form-group">
                                    <label for="name" class="col-sm-2 control-label">Popup Adı</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="name" id="name" value="{{$popup->name}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="ckeditor" class="col-sm-2 control-label">İçerik</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control editor"  name="content" style="height: 140px; visibility: hidden; display: none;">{{$popup->content}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <select name="status" id="status" class="selectpicker show-tick bs-select-hidden" data-style="form-control" data-title="Durum Seçiniz" data-width="100%"><option class="bs-title-option" value="">Durum Seçiniz</option>
                                            <option {{$popup->status==1?"selected":""}} value="1">Aktif</option>
                                            <option {{$popup->status==0?"selected":""}} value="0">Pasif</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="frequency" id="frequency" value="{{ $popup->frequency }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="checkbox" name="homeStatus" value="{{$popup->homeStatus}}" {{$popup->homeStatus == 1 ? "checked" : "" }} id="homeStatus"  class="js-switch" data-size="medium" data-color="#4F5467" data-switchery="true" style="display: none;">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="checkbox" name="category" {{$popup->categories == null ? "" : "checked" }} id="category"  class="js-switch" data-size="medium" data-color="#4F5467" data-switchery="true" style="display: none;">
                                    </div>
                                </div>

                                <div id="usage_4" style="{{$popup->categories == null ? "display:none;" : "" }}">
                                    <div class="form-group">
