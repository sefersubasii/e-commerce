        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Yeni Ülke Ekle</h4>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-15">Ülke Ekle</h3>

                        <form method="post" action="{{url('admin/countries/update/'.$data->id)}}" class="form-horizontal form-bordered">
                            <div class="form-body">
                                <div class="form-group">
                                    <label for="name" class="col-sm-2 control-label">Ülke Adı</label>
                                    <div class="col-sm-10">
