                    ...
                    <ul class="ufb_icerik force-overflow">
                        @foreach($brandsProdCount as $br)
                            <li>
                                <label>
                                    <input 
                                        @if((isset($brands) && in_array($br["slug"], $brands)) || count($brandsProdCount) == 1)
                                            checked 
                                        @endif
                                        data-filter="brand" 
                                        value='{{ $br["slug"] }}'  
                                        type="checkbox" 
                                        class="filtre_chec filterBrand"
                                    >
                                    <span>{{$br["name"]}} ( {{$br["count"]}} )</span>
                                </label>
                            </li>
                        @endforeach
                    </ul>
                ...
                <div class="scrollbar" id="style-1">
                    <ul class="ufb_icerik force-overflow">
                        <li>
                            <label>
                                <input 
                                    {{ !in_array('stokhepsi', $filtreler) ? 'checked' : ''}} 
                                    value="stokhepsi" 
                                    type="checkbox" 
                                    type="checkbox" 
                                    class="filtre_chec filterStock"
                                >
