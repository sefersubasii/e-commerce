...
@section('content')
    ...
    <div class="container">
        ...
        <div class="container_ic">
            ...
            @if(!empty($brandsProdCount))
            <div class="uf_blok">
                <div class="ufb_baslik">MARKALAR</div>
                <div class="scrollbar" id="style-1">
                    <ul class="ufb_icerik force-overflow">
                        @foreach($brandsProdCount as $br)
                            <li><label><input data-filter="brand" value='{{$br["slug"]}}' @if(count($brandsProdCount) == 1) checked @endif type="checkbox" class="filtre_chec filterBrand"><span>{{$br["name"]}} ( {{$br["count"]}} )</span></label></li>
                        @endforeach
                    </ul>
                </div>
            ...
            <div class="uf_blok">
                ...
                <div class="scrollbar" id="style-1">
                    <ul class="ufb_icerik force-overflow">
                            <li><label><input value="stokhepsi" type="checkbox" {{($filtreler == "stokhepsi") ? '':'checked'}} type="checkbox" class="filtre_chec filterStock"><span>Stokta Mevcut</span></label></li>
                    </ul>
                </div>
            </div>
